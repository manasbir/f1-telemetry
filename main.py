...
# for team in drs_data:
#     plt.scatter(drs_data[team]['all']['v^2 (m^2/s^4)'], drs_data[team]['all']['F_lost (N)'], label=team)

#     # Perform linear regression
#     coeffs = np.polyfit(drs_data[team]['all']['v^2 (m^2/s^4)'], drs_data[team]['all']['F_lost (N)'], 1)
#     regression_line = np.poly1d(coeffs)

#     # Plot regression line
#     plt.plot(drs_data[team]['all']['v^2 (m^2/s^4)'], regression_line(drs_data[team]['all']['v^2 (m^2/s^4)']), label=f'Regression Line ({team})')
...
plt.scatter(data['Red Bull']['Las Vegas Grand Prix']['v^2 (m^2/s^4)'], data['Red Bull']['Las Vegas Grand Prix']['F_lost (N)'], label='RB19')
plt.xlabel('v^2 (m^2/s^4)')
plt.ylabel('F_lost (N)')
plt.title('F_lost (N) vs v^2 (m^2/s^4) for the RB19 without DRS')
plt.legend()
plt.show()

plt.savefig('LV-RB19-NO-DRS.png', bbox_inches='tight')

plt.scatter(drs_data['Red Bull']['Las Vegas Grand Prix']['v^2 (m^2/s^4)'], drs_data['Red Bull']['Las Vegas Grand Prix']['F_lost (N)'], label='RB19')
plt.xlabel('v^2 (m^2/s^4)')
plt.ylabel('F_lost (N)')
plt.title('F_lost (N) vs v^2 (m^2/s^4) for the RB19 with DRS')
plt.legend()
plt.show()
plt.savefig('LV-RB19-DRS.png', bbox_inches='tight')
